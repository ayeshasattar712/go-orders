    ...
    <div className="bg-background min-h-screen">
      <aside className="bg-sidebar text-sidebar-foreground border-sidebar-border fixed inset-y-0 left-0 z-30 hidden w-64 flex-col border-r md:flex">
        <div className="border-sidebar-border flex h-16 items-center gap-2 border-b px-5">
          ...
          <div>
            <p className="text-sm leading-none font-bold text-white">GoOrder</p>
            <p className="text-sidebar-muted text-[11px]">Admin Panel</p>
          </div>
        </div>
        ...
        <nav className="flex-1 space-y-6 overflow-y-auto px-3 py-5">
          {groups.map((group) => (
            <div key={group.label}>
              <p className="text-sidebar-muted px-3 text-[11px] font-semibold tracking-wider uppercase">
                {group.label}
              </p>
        ...
        <div className="border-sidebar-border border-t p-3">
          <div className="mb-2 px-3 text-sm">
            ...
            <p className="text-sidebar-muted mt-1 text-xs tracking-wide uppercase">{user?.role}</p>
          </div>
          <Button
            type="button"
            variant="outline"
            className="border-primary/40 text-primary-foreground bg-primary/15 hover:bg-primary mb-1 w-full hover:text-white"
          ...
          <Link
            href="/"
            className="text-sidebar-muted flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white"
          >
