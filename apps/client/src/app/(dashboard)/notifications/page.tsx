...
import type { AppNotification, NotificationType } from '@/types/admin';
...
export default function NotificationsPage() {
  ...
  async function markAllRead() {
    await notificationsService.markRead(undefined, true);
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground">
            Payment, invoice, and delivery alerts for your orders.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <CardContent>
          {notifications.length === 0 ? (
            <EmptyState
              ...
              description="Alerts appear when you order or when a rider attempts delivery."
            />
          ) : (
