...
import { getProducts, getVendorBySlug } from '@/lib/catalog/catalog-repository';
...
const performanceMetrics = (vendor: Vendor) => [
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="-mt-14 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex items-end gap-4">
            <VendorAvatar
              name={vendor.name}
              className="border-background h-24 w-24 shrink-0 rounded-2xl border-4 text-xl shadow-lg"
            />
            <div className="pb-1">
