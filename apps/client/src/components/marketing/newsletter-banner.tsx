...
export function NewsletterBanner() {
  return (
    <section className="bg-background px-4 py-10 sm:px-6">
      <div className="glow-accent bg-navy mx-auto flex max-w-7xl flex-col items-center gap-6 rounded-3xl px-6 py-10 text-center text-white sm:px-12 lg:flex-row lg:text-left">
        <span className="bg-primary flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl">
