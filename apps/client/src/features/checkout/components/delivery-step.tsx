...
import { Clock, CalendarClock, CheckCircle2, Truck, Zap } from 'lucide-react';
...
const options: {
  ...
  {
    id: 'hour',
    label: 'Deliver within 1 hour',
    description: 'Rider pickup now — arrives in about 60 minutes',
    price: 99,
    icon: Clock,
  },
  {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground text-sm">
        Same-hour delivery or 1–5 day shipping. Estimated arrival is shown on your order after you
        pay.
      </p>
