        ...
        {approvedVendors.map((vendor) => {
          ...
          return (
            <Link
              ...
              className="card-hover bg-card overflow-hidden rounded-2xl border"
            >
              ...
              <div className="flex items-start gap-3 p-5">
                <div className="border-card bg-background relative -mt-12 h-16 w-16 shrink-0 overflow-hidden rounded-xl border-4">
                  <Image
                    src={vendor.logo}
                    alt={vendor.name}
                    fill
