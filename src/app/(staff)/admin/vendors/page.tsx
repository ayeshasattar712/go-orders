...
import { useAdminStore, type VendorInput } from '@/store/admin-store';
...
export default function AdminVendorsPage() {
  ...
  const registerVendor = useAdminStore((state) => state.registerVendor);
  const setVendorStatus = useAdminStore((state) => state.setVendorStatus);
    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Product categories (comma separated IDs, e.g. cat_it, cat_electrical)</Label>
