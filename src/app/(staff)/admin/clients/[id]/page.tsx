...
export default function AdminClientDetailPage() {
  ...
  const [newLimit, setNewLimit] = useState(client?.creditLimit ?? 0);
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap items-end gap-3">
            ...
            <Button onClick={() => adjustCreditLimit(client.id, newLimit)}>
              <Save className="h-4 w-4" /> Update limit
            </Button>
            {client.creditFrozen ? (
              <Button variant="outline" onClick={() => setCreditFrozen(client.id, false)}>
                <Unlock className="h-4 w-4" /> Unfreeze account
              </Button>
            ) : (
              <Button variant="outline" onClick={() => setCreditFrozen(client.id, true)}>
