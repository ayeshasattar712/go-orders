...
import { vendors as seedVendors } from '@/lib/mock-data/vendors';
import { clients as seedClients } from '@/lib/mock-data/admin';
import { invoices as seedInvoices } from '@/lib/mock-data/enterprise';
import { invoiceAlertRules as seedAlertRules } from '@/lib/mock-data/admin';
...
export const useAdminStore = create<AdminState>()(
  persist(
    (set, get) => ({
      ...
      invoiceAlertRules: seedAlertRules,
